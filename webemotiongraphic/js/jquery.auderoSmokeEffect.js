...
(function ($) {
   ...
   var createPuff = function ($element) {
      ...
      $smokePuff
         .animate({
            ...
            marginTop: "-" + (options.height * 0.8) + "px",
            opacity: 0.9
         },
         options.speed * (1 / 1)
      )
         .animate({
            marginTop: "-" + (options.height * 1) + "px",
            opacity: 0
         },
         options.speed * (1 / 1),
         function() {
            ...
            var time = (options.pause === "random") ? options.speed * (1 / 1) + Math.round(Math.random() * 2000) : options.pause;
   ...
   $.fn.auderoSmokeEffect.defaults = {
      ...
      pause: 100,     // number (optional). The time (milliseconds) between animations. Set to "random" to have a random time
